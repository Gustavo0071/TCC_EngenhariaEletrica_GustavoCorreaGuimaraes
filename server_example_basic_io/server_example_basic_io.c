...
main(int argc, char** argv)
{
    ...
    while (running)
    {
        ...
        //IedServer_updateTimestampAttributeValue(iedServer, IEDMODEL_PRODIST_MMXU1_PNV_phsA_cVal_t, &iecTimestamp);
        //IedServer_updateFloatAttributeValue(iedServer, IEDMODEL_PRODIST_MMXU1_PNV_phsA_cVal_mag_f, an1);

        //IedServer_updateTimestampAttributeValue(iedServer, IEDMODEL_PRODIST_MMXU1_Hz_mag_t, &iecTimestamp);
        //IedServer_updateFloatAttributeValue(iedServer, IEDMODEL_PRODIST_MMXU1_Hz_mag_f, an2);

        IedServer_updateTimestampAttributeValue(iedServer, IEDMODEL_PRODIST_MMXN1_Amp_t, &iecTimestamp);
        IedServer_updateFloatAttributeValue(iedServer, IEDMODEL_PRODIST_MMXN1_Amp_mag_f, an3);

        IedServer_updateTimestampAttributeValue(iedServer, IEDMODEL_PRODIST_MMXN1_Vol_t, &iecTimestamp);
        IedServer_updateFloatAttributeValue(iedServer, IEDMODEL_PRODIST_MMXN1_Vol_mag_f, an4);
